...
- [修复] Wan 2.7 生图能力公开 1–9 张有序参考图编辑；生图、视频工作台可从素材中心插入参考素材，并通过 `@图片N`、`@视频N`、`@音频N` 与提示词关联后随任务提交。
- [优化] 画布提示词面板新增“添加参考”入口，插入素材会自动连接到当前节点或其配置节点；连续时长模型改为按服务端范围的秒数滑杆，HappyHorse 可选 3–15 秒。
