...
type RuntimeConfig = {
    ...
    CREATIVE_API_BASE?: string;
    FYJIT_HOME_URL?: string;
...
export const CREATIVE_API_BASE = read("CREATIVE_API_BASE", import.meta.env.VITE_CREATIVE_API_BASE, "/api/creative").replace(/\/+$/, "");
