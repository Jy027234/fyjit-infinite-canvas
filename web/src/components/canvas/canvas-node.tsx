...
function VideoNodeContent({ node, theme }: NodeContentRendererProps) {
    ...
    return <video src={node.metadata.content} poster={node.metadata.posterUrl} controls preload="none" className="h-full w-full rounded-[18px] bg-black object-contain" data-canvas-no-zoom />;
}
