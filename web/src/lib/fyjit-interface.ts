...
const translations = {
    zhCN: {
        ...
        signOutConfirmDescription: "退出后需要重新登录才能继续使用创作中心。",
        cancel: "取消",
        docs: "文档",
        lightTheme: "切换到浅色主题",
        darkTheme: "切换到深色主题",
    ...
    zhTW: {
        ...
        logout: "登出",
        loggingOut: "正在登出…",
        signOutConfirmTitle: "要登出嗎？",
        signOutConfirmDescription: "登出後需要重新登入才能繼續使用創作中心。",
        cancel: "取消",
        docs: "文件",
        lightTheme: "切換至淺色主題",
        darkTheme: "切換至深色主題",
    ...
    en: {
        ...
        signOutConfirmDescription: "You will need to sign in again to continue using the Creative Center.",
        cancel: "Cancel",
        docs: "Documentation",
    ...
    fr: {
        ...
        signOutConfirmDescription: "Vous devrez vous reconnecter pour continuer à utiliser le centre créatif.",
        cancel: "Annuler",
        docs: "Documentation",
    ...
    ru: {
        ...
        signOutConfirmDescription: "Чтобы продолжить работу в творческом центре, потребуется снова войти.",
        cancel: "Отмена",
        docs: "Документация",
    ...
    ja: {
        ...
        signOutConfirmDescription: "クリエイティブセンターを引き続き利用するには、再度ログインが必要です。",
        cancel: "キャンセル",
        docs: "ドキュメント",
    ...
    vi: {
        ...
        signOutConfirmDescription: "Bạn cần đăng nhập lại để tiếp tục sử dụng Trung tâm sáng tạo.",
        cancel: "Hủy",
        docs: "Tài liệu",
